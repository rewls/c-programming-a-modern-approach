/*
 * 03.c (Chapter 16, page 412, Programming Project 3)
...
/*
 * main:
 *     Prompts the user to enter an operation code, then calls a function to
...
/*
 * find_part:
 *     Looks up a part number in the inventory array. Returns the array index
...
/*
 * insert:
 *     Prompts the user for information about a new part and then inserts the
 *     part into the database in order by part number. Prints an error message
 *     and returns prematurely if the part already exists or the database is
 *     full.
 */
void insert(struct part inventory[], int *num_parts)
{
 ...
 *     database. If the part exists, prints the name and quantity on hand; if
...
/*
 * update:
 *     Prompts the user to enter a part number. Prints an error message if the
 *     part doesn't exist; otherwise, prompts the user to enter change in
 ...
 *     part name, and quantity on hand. Parts are printed in the order in which
